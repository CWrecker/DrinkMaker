...
//Pumps
int SETPump1Measure = GinMeasure;
int SETPump2Measure = GinMeasure;
int SETPump3Measure = GinMeasure;
int SETPump4Measure = GinMeasure;
int SETPump5Measure = GinMeasure;
int SETPump6Measure = GinMeasure;
int SETPump7Measure = GinMeasure;
int SETPump8Measure = GinMeasure;
...
void Mint() {
  ...
  digitalWrite(IN2, LOW);  //MINT wheel turning forwards
  analogWrite(ENA, 200);
  delay(2000);
  analogWrite(ENA, 0);
